...
#define OTA_META_LENGTH                (18)      /// the index of meta data + meta data info.
...
@interface MainViewController : DCBaseController <bleDidConnectionsDelegate, otaApiUpdateAppDataDelegate> {
